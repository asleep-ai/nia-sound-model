...
if __name__ == '__main__':
    edfObj = EDFReader('/HDD/nia/data_backup/c011klqp_2022-07-30_211239-4-raw.edf')     # normal
    # edfObj = EDFReader('/HDD/nia/data_backup/c010nrkz_2022-07-29_044907-2-raw.edf')     # error
    # edfObj = EDFReader('/HDD/nia/data_backup/c020wwej_2022-08-10_225855-3-raw.edf')     # error
    ...
    print(edfObj.meas_info['n_records'])
    print(edfObj.chan_info['n_samps'][-1])
    assert mel_data.shape[1] == edfObj.meas_info['n_records'] * edfObj.chan_info['n_samps'][-1]
